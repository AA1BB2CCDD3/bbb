...
<div class="contacts">	
		<?php echo $this->item->text; ?>
						<div class="contact-form">
							...
							<label>Vardas</label><input class="name" type="text">
							<label>Telefonas</label><input class="phone" type="text">
							<label>El pastas</label><input class="mail" type="text">
							<div class="message-wrapper">
								<label>Zinute</label><textarea></textarea>
							</div>
							<input type="submit">
							</div>
							<div>
