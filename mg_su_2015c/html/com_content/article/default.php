...
<div class="item-page<?php echo $this->pageclass_sfx; ?>" itemscope itemtype="http://schema.org/Article">
	...
	<div class="page-header">
		...
		<a class="back up"  href="javascript: history.go(-1)">Grįžti</a>
	</div>
	
					<div class="date" style = "border-bottom: 1px solid #d9c8b6; padding-bottom: 5px;">
						<div class="fb-share-button" style="margin-left:600px;" data-href="https://developers.facebook.com/docs/plugins/" data-layout="button"></div>
...
<?php // new ------------------------------------------------------------------------------------------- ?>	
					...
					<div class="date"><span><?php echo JHtml::_('date', $this->item->created, 'Y');?></span><?php echo JHtml::_('date', $this->item->created, 'F');?> <?php echo JHtml::_('date', $this->item->created, 'd');?> d.
...
<?php // new ------------------------------------------------------------------------------------------- ?>	
<?php //if ($params->get('show_create_date')) : ?>
	<a class="back down"  href="javascript: history.go(-1)">Grįžti</a>	
<?php //endif; ?>	
<?php // new ------------------------------------------------------------------------------------------- ?>	
