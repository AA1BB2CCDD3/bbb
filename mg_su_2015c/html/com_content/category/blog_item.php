...
Renginio data:
<!--<span> rugpjūčio 7 d.</span> -->
<span><?php echo JHtml::_('date', $this->item->created, 'F');?> <?php echo JHtml::_('date', $this->item->created, 'd');?> d.</span>
</h2>
<?php // new - -----------------------------------------------------------------------------------------------------------?>
...
<?php if ($params->get('show_readmore') && $this->item->readmore) :
	...
	<?php echo '<a class="more" href="'.$link.'"> Išsamiau</a>'; ?>
