		...
		<?php
			...
			if ($button) :
				if ($imagebutton) :
					...
					/*$btn_output = ' <button class="button btn btn-primary header-search-submit" onclick="this.form.searchword.focus();"></button>'; */
					$btn_output = '	<input class="header-search-submit" value = "" type="submit" onclick="this.form.searchword.focus();"/> ';
