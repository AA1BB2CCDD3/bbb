...
if (isset($this->category->description) && $this->category->description != '' ) {
	echo '<div class="pg-cv-desc"><p>'.strip_tags($this->category->description).'</p></div>';//'<div class="pg-cv-desc">'. JHTML::_('content.prepare', $this->category->description) .'</div>'. "\n";
}
...
echo '</div>';
//NEW
echo '<a class="back up"  style="margin-bottom: -25px;" href="javascript: history.go(-1)">Grįžti</a>';
//NEW
?>